...
sidebar:
    ...
    order: 2
---
Millones de estudiantes de todos los países del mundo entero van diariamente a la Escuela y a la Universidad en forma inconsciente, automática, subjetiva, sin saber por qué, ni para qué. Los estudiantes son obligados a estudiar Matemáticas, Física, Química, Geografía, etc.
...
La humanidad tiene un noventa y siete por ciento de SUBCONSCIENCIA y tres por ciento de CONCIENCIA.
