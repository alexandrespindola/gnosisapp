...
Vaig a llegir el periòdic diu el JO INTEL·LECTUAL; Vull assistir a la festa exclama el JO EMOCIONAL; al DIABLE amb la festa gruny el JO DEL MOVIMENT, millor me'n vaig a passejar, JO no vull passejar crida el JO de l'instint de conservació, tinc gana i vaig a menjar, etc.

Cadascun dels petits JOS que constitueixen l'EGO, vol manar, ser l'amo, el senyor.

A la llum de la psicologia revolucionària podem comprendre que el JO és legió i que l'organisme és una màquina.

Els petits JOS renyen entre si, es barallen per la supremacia, cadascú vol ser el cap, l'amo, el senyor.
...
És necessari comprendre què significa la paraula DESINTEGRACIÓ en PSICOLOGIA. Desintegrar-se és desballestar-se, dispersar-se, esgarrar-se, contradir-se, etc.
...
El ric enveja el ric i vol ser més ric. Els pobres envegen els rics i volen ser rics també. El que escriu enveja el que escriu i vol escriure millor. El que té molta experiència enveja el que té més experiència i desitja tenir-ne més que aquell.
...
Tot això és dolor. Res d'això pot portar content veritable al cor afligit. Tot això produeix augment de crueltat en la nostra psique, multiplicació del dolor, descontent cada vegada i més profund.

EL JO PLURALITZAT troba sempre justificatius fins i tot per als pitjors delictes i a aquest procés d'envejar, adquirir, acumular, aconseguir, fins i tot quan sigui a costa del treball aliè, se l'anomena evolució, progrés, avanç, etc.
...
L'enveja comença des dels bancs de l'escola. Envidiem la millor intel·ligència dels nostres condiscípuls, les millors qualificacions, els millors vestits, els millors vestits, les millors sabates, la millor bicicleta, els hermosos patins, la bonica pilota, etc. etc.

Els mestres i mestresses anomenats a formar la personalitat dels alumnes i alumnes, han de comprendre el que són els infinits processos de l'enveja i establir dins de la PSIQUE dels seus estudiants el fonament adequat per a la comprensió.
...
El pensar comparatiu es basa en l'enveja i produeix això que s'anomena descontentament, desassossec, amargura.

Desgraciadament la gent va d'un oposat a un altre oposat, d'un extrem a un altre, no saben caminar pel centre. Molts lluiten contra el descontentament, l'enveja, la cobdícia, la gelosia, però la lluita contra el descontentament no porta mai el veritable content del cor.

És urgent comprendre que el veritable content del cor tranquil, no es compra ni es ven i només neix en nosaltres amb entera naturalitat i en forma espontània quan hem comprès a fons les causes mateixes del descontentament; gelosia, enveja, cobdícia, etc. etc.
...
La ment embotellada en el JO PLURALITZAT fa de l'enveja una virtut i fins i tot es dona el luxe de posar-li noms deliciosos. Progrés, evolució espiritual, anhel de superació, lluita per la dignificació, etc. etc. etc.
...
Resulta totalment impossible aconseguir la INTEGRACIÓ TOTAL mentre existeixi dins de nosaltres mateixos el JO PLURALITZAT.
...
El JO PLURALITZAT malgasta torpement el material psicològic en explosions atòmiques d'enveja, gelosia, cobdícia, etc. etc. És necessari dissoldre el JO pluralitzat, amb el propòsit d'acumular dins, el material psíquic per establir en el nostre interior un centre permanent de consciència.

Els qui no posseeixen un centre permanent de consciència, no poden ser íntegres.

Només el centre permanent de consciència ens dona veritable individualitat.
