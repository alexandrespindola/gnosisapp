---
title: La Oración en el Trabajo
locale: es
...
sidebar:
    label: 32. La Oración en el Trabajo
    order: 32
---
...
De nada serviría repetir: "no seré lujurioso"; los Yoes de la lascivia de todas maneras continuarían existiendo en el fondo mismo de nuestra psiquis.
