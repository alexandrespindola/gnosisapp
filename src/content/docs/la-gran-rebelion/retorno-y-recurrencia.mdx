...
sidebar:
    label: 22. Retorno y Recurrencia
    order: 22
---
...
Los diversos yoes que retornan dan vueltas alrededor del recién nacido, van y vienen libremente por doquiera, quisieran meterse dentro de la máquina orgánica más esto no es posible en tanto no se haya creado una nueva personalidad.
